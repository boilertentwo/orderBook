...
export function Login() {
    ...
    return (
        ...
        <div className="min-h-screen min-w-full flex flex-col justify-center items-center bg-gradient-to-r from-blue-950 to-blue-300">
           ...
           <form className="flex flex-col justify-around font-bold" onSubmit={handleSubmit(onSubmit)}> 
                <div>
                    ...
                    <button className="w-full bg-black text-white mt-3" type="submit">Submit</button>
                </div>
